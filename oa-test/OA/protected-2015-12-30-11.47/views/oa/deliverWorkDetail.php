...
<div>
	...
	?>
    <!-- 标题 -->
	<h4 class="pd10 m0 b33 bor-1-ddd">工作交接详情</h4>
    <!--交接进度-->
	<div class="bor-l-1-ddd bor-r-1-ddd">
        <ul class="nav nav-justified">
            <!-- 发起工作交接 -->
            <li class="bg-66 flow-li">
                <h4 class="white m0 mt5 center">1.发起工作交接</h4>
            ...
            <li class="bg-66 flow-li">
                <h4 class="white m0 mt5 center">2.部门交接</h4>
                <div class="center"><span class="mt5 mb10 f18px white glyphicon glyphicon-ok-sign"></span></div>
            </li>
        	<?php else: ?>
        	<li>
                <h4 class="m0 mt5 center">2.部门交接</h4>
                <div class="center"><span class="mt5 mb10 f18px glyphicon glyphicon-time"></span></div>
            </li>
        	<?php endif; ?>
        	<!-- 人事行政部交接 -->
        	<?php if(!empty($admin) && !empty($hr) && $admin->status == "success" && $hr->status == "success"): ?>
			<li class="bg-66 flow-li">
                <h4 class="white m0 mt5 center">3.人事行政部交接</h4>
                <div class="center"><span class="mt5 mb10 f18px white glyphicon glyphicon-ok-sign"></span></div>
            </li>
        	<?php else: ?>
        	<li>
                <h4 class="m0 mt5 center">3.人事行政部交接</h4>
                <div class="center"><span class="mt5 mb10 f18px glyphicon glyphicon-time"></span></div>
            </li>
        	<?php endif; ?>
        	<!-- IT运维部交接 -->
        	<?php if(!empty($it) && $it->status == "success"): ?>
            <li class="bg-66 flow-li">
                <h4 class="white m0 mt5 center">4.IT运维部交接</h4>
                <div class="center"><span class="mt5 mb10 f18px white glyphicon glyphicon-ok-sign"></span></div>
            </li>
            <li class="bg-66">
                <h4 class="white m0 mt5 center">5.工作交接完成</h4>
                <div class="center"><span class="mt5 mb10 f18px white glyphicon glyphicon-ok-sign"></span></div>
            </li>
        	<?php else: ?>
        	<li>
                <h4 class="m0 mt5 center">4.IT运维部交接</h4>
                <div class="center"><span class="mt5 mb10 f18px glyphicon glyphicon-time"></span></div>
            </li>
            <!-- 工作交接完成 -->
            <li>
                <h4 class="m0 mt5 center">5.工作交接完成</h4>
                <div class="center"><span class="mt5 mb10 f18px glyphicon glyphicon-time"></span></div>
            </li>
        	<?php endif; ?>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php if(!empty($work) && $work->status == 'success'): ?>
					<!-- 显示签名 -->
					<p class="f15px m0"><?php $supervision_info->cn_name; ?></p>
	...
	<?php if(!empty($apply)): ?>
	<div class=" bor-l-1-ddd bor-r-1-ddd bor-b-1-ddd">
		<div class="w130 m0a">
			<button class="btn btn-success w130 mb15 mt10" onclick="location.href='/oa/quitDetail/id/<?php echo empty($apply->id) ? '': $apply->id;?>';">查看离职申请单</button>
		</div>
	</div>
	<?php endif; ?>
</div>
