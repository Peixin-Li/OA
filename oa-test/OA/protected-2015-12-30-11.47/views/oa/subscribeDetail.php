        ...
        <td><?php echo $apply->create_time; ?></td>
  		...
  		<tr>
            ...
            <?php if($details = $apply->details): ?>
                ...
                <th class="center w130">数量/单位</th>
                <th class="center w130">预计单价</th>
                <th class="center w100">小计(元)</th>
                <th class="center w100">申请方式</th>
                <th class="center w100">使用时间</th>
                <th class="center w130">参考链接</th>
              ...
              <?php $attachment_path = ""; foreach($details as $key=>$row): ?>
                ...
                <td><?php echo $row->name; ?></td>
  							<td class="quantity-td"><?php echo $row->quantity; ?></td>
  							<td class="price-td"><?php echo $row->price; ?></td>
                ...
                <td><?php if(!empty($row->url) && $row->url != 'http://'): ?><a href="<?php echo $row->url; ?>"><?php echo $row->url; ?></a><?php endif; ?></td>
