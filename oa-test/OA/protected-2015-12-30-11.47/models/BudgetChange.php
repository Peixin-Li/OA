...
/**
 * This is the model class for table "budget_change".
 *
 * The followings are the available columns in table 'budget_change':
 * @property integer $id
 ...
 */
class BudgetChange extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BudgetChange the static model class
	 */
