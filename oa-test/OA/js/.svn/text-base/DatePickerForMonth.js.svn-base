...
Calendar.prototype.style = function(){
	var strStyle = "<style type='text/css'>";
	strStyle += ".calendar {font-size:15px; margin:0;padding:0px;border:1px solid #ddd;font-family:'Microsoft YaHei' ! important;border-radius:3px;}";
	strStyle += ".calendar ul {list-style-type:none; margin:0; padding:0;vertical-align:middle;}";
	strStyle += ".calendar li {float:left;}.calendar b{font-weight:bold;}";
	strStyle += ".calendar .day { background-color:#EDF5FF; height:20px;}";
	strStyle += ".calendar .day li,.calendar .date li{ float:left; width:14.13%; height:20px; line-height:20px; text-align:center}";
	strStyle += ".calendar .month li{ float:left; width:24.8%; height:30px;vertical-align:center; line-height:20px; text-align:center}";
	strStyle += ".calendar li a{text-decoration:none; font-family:Tahoma; font-size:15px; color:#333}";
	...
	strStyle += ".today{ /*background-color:rgb(200,200,200);*/ padding:0 1px;}";
	strStyle += ".today a { color:#f30;  }";
  strStyle += ".li-today{ background:#FFFF99;}";
	strStyle += ".calendarBottom {text-align:center;height:20px;line-height:20px;clear:both;width:100%;border-top:1px solid #ddd;}";
	strStyle += ".calendarBottom li{float:left;height:20px;line-height:20px;font-weight:bold;text-align:center;}";
	strStyle += "</style>";
	return strStyle;
...
Calendar.prototype.draw = function() {   
  ...
  if("d" == this.type){
	...
	for (i = 1; i <= thisMonthEndDate; i++) { // Current Month's Date
		...
		lis += "<li class='thisMonth' title='" + currentDate.format("yyyy-MM-dd") + "'><a style='vertical-align:middle' href='javascript:void(0);' ";
	...
	lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + Calendar.language.today[this.lang][0] +"</li>";
      ...
      lis += "' title='" + this.year + "-" + (i>9?i:"0"+i) + "-01'><a style='vertical-align:middle' href='javascript:void(0);'";
...
document.write('<div id="calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background: -webkit-gradient(linear, left top, left bottom, from(white), to(#f5f5f5));background: -moz-linear-gradient(top,#ffffff,#f5f5f5);font-size:12px;width:20px;">');
document.write("<iframe id='calendarIframe' scrolling='no' frameborder='0' width='100%' height='133px'></iframe></div>");